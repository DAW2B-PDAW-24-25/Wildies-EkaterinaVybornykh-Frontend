...
function Inicio() {
    ...
    async function cargarUsuarios() {
        try {
            let response = await fetch(`${API_URL}/api/usuarios/usuariosCerca/${usuarioLogueado.id}`);
    ...
    async function cargarEventos() {
        try {
            let response = await fetch(`${API_URL}/api/eventos/eventosCerca/${usuarioLogueado.id}`);
